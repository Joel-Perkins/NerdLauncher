...
/**
 * Created by p623419 on 3/23/2016.
 */
public class NerdLauncherFragment extends Fragment {
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ActivityHolder(View itemView) {
            super(itemView);
            mNameTextView = (TextView) itemView.findViewById(R.id.tvActivityName);
            mNameTextView.setOnClickListener(this);
            mActivityImageView = (ImageView) itemView.findViewById(R.id.ivActivityImage);
        }

        public void bindActvity(ResolveInfo resolveInfo) {
            mResolveInfo = resolveInfo;
            PackageManager pm = getActivity().getPackageManager();
            String appName = mResolveInfo.loadLabel(pm).toString();
            mNameTextView.setText(appName);
            mActivityImageView.setImageDrawable(mResolveInfo.loadIcon(pm));
        }
    ...
    private class ActivityAdapter extends RecyclerView.Adapter<ActivityHolder> {
        ...
        public void onBindViewHolder(ActivityHolder holder, int position) {
            ...
            holder.bindActvity(resolveInfo);
        }
